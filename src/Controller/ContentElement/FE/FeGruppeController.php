...
//        \System::log('PBD Spielecontroller nach dependencyAggregate', __METHOD__, TL_GENERAL);
    ...
    protected function getResponse(Template $template, ContentModel $model, Request $request): ?Response
    {
      ...
      $html.=$c->thead().$c->tr();
      $html.=$c->th(array("class"=>"vorsortiert"),"Gruppe");
      $html.=$c->th(array("class"=>"sortierbar"),"M1");
      $html.=$c->th(array("class"=>"sortierbar"),"Platz").$c->th("Spiele").$c->th("Sieg").$c->th("Unentschieden").$c->th("Niederlage").$c->th("Tore").$c->th("Gegentore").$c->th("Differenz").$c->th("Punkte");
